<!-- begin #content -->
	<div id="content" class="content">
		...
		<!-- end page-header -->
		<form action="<?=base_url()?>administrator/delete_slider?route=system" method="post">
		<!-- begin row --> 
		<div class="row">
		    <!-- begin col-12 -->
		    <div class="col-md-12">
                ...
                <div class="panel panel-inverse">
                    ...
                    <div class="panel-body" >
                        ...
                        <a href="add_slider?route=system" class="btn btn-primary m-r-5 pull-right" title="add"><i class="fa fa-plus"></i></a>
                    </div>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                            <tr class="odd gradeX">
                                                ...
                                                <td><?=$row->link?></td>
                                                <td class="text-right">
                                                    <a class="btn btn-warning btn-icon btn-circle" href="<?=base_url()?>administrator/edit_slider/<?=$row->id?>?route=system"><i class="fa fa-pencil"></i></a>
                                                </td>
                                            </tr>
                                            <?php endforeach; ?>
                                        <?php else: ?>
