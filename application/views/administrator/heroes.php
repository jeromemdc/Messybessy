<!-- begin #content -->
	<div id="content" class="content">
		...
		<!-- end page-header -->
		<form action="<?=base_url()?>administrator/delete_hero?route=system" method="post">
		<!-- begin row -->
		<div class="row">
		    <!-- begin col-12 -->
		    <div class="col-md-12">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                            <tr class="odd gradeX">
                                                ...
                                                <td><?=$row->title?></td>
                                                <td class="text-right">
                                                    <a class="btn btn-warning btn-icon btn-circle" href="<?=base_url()?>administrator/edit_hero/<?=$row->id?>?route=system"><i class="fa fa-pencil"></i></a>
                                                </td>
                                            </tr>
                                            <?php endforeach; ?>
                                        <?php else: ?>
