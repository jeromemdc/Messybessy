                ...
                <div class="tab-pane fade active in" id="default-tab-1">
                    <div class="panel-body form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control" name="price" value="" data-parsley-type="number" data-parsley-required="true" onkeypress="return onlyDotsAndNumbers(event)"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <?=form_dropdown('cat_id', $categories, '', 'class="form-control" data-parsley-required="true"');?>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control" name="points" value="0" onkeypress="return onlyDotsAndNumbers(event)" />
                            </div>
                        </div>
