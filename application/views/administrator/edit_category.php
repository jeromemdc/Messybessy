...
<div id="content" class="content">
    ...
    <!-- begin row -->
    <?=form_open_multipart('administrator/edit_category/'.$result->cat_id.'?route=catalog','class=form-horizontal data-parsley-validate=true' );?>
    <div class="row">
        <!-- begin col-6 -->
        <div class="col-md-12">
                ...
                <div class="tab-pane fade active in" id="default-tab-1">
                    <div class="panel-body form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-2">
                                <input type="number" class="form-control" name="sort" value="<?=($result->sort == 0 ? $result->cat_id : $result->sort)?>"/>
                            </div>
                        </div>
