        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
                ...
                <div class="panel-body">
					...
					<?=form_open('administrator/add_store?route=system','class=form-horizontal data-parsley-validate=true' );?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <textarea name="address" class="form-control" id="" cols="30" rows="10"><?=set_value('address')?></textarea>
                            </div>
                        </div>
