        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
                ...
                <div class="panel-body">
					...
					<?=form_open_multipart('administrator/edit_hero/'.$result->id.'?route=system','class=form-horizontal data-parsley-validate=true' );?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control" name="age" value="<?=$result->age?>" data-parsley-required="true" onkeypress="return onlyDotsAndNumbers(event)"/>
                            </div>
                        </div>
